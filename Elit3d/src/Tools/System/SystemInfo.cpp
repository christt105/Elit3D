...
#if defined(_WIN64)
#ifdef _DEBUG
#pragma comment(lib, "src/ExternalTools/infoware/libx64/_Debug/infowared.lib")
#else
#pragma comment(lib, "src/ExternalTools/infoware/libx64/_Release/infoware.lib")
#endif
#else
#ifdef _DEBUG
#pragma comment(lib, "src/ExternalTools/infoware/libx86/_Debug/infowared.lib")
#else
#pragma comment(lib, "src/ExternalTools/infoware/libx86/_Release/infoware.lib")
#endif
#endif
