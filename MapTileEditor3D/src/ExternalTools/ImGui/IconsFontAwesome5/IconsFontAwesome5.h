...
#define FONT_ICON_FILE_NAME_FAR (FileSystem::sAppdata + "/Configuration/Fonts/fa-regular-400.ttf").c_str()
#define FONT_ICON_FILE_NAME_FAS (FileSystem::sAppdata + "/Configuration/Fonts/fa-solid-900.ttf").c_str()
